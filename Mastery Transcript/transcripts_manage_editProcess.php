...
$URL = $session->get('absoluteURL')."/index.php?q=/modules/Mastery Transcript/transcripts_manage_edit.php&masteryTranscriptTranscriptID=$masteryTranscriptTranscriptID";
