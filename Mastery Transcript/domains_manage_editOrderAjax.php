...
$_POST['address'] = '/modules/Mastery Transcript/domains_manage.php';
...
if (isActionAccessible($guid, $connection2, '/modules/Mastery Transcript/domains_manage.php') == false) {
    ...
    if (empty($order)) {
        ...
        $count = 1;
        foreach ($order as $masteryTranscriptDomainID) {
            $updated = $domainGateway->update($masteryTranscriptDomainID, ['sequenceNumber' => $count]);
            $count++;
        }
    }
}
